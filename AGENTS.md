...
Do not copy an internal archive into it to fill an evidence gap. Referenced
upstream implementations retain their own licenses.
Owner-authorized, generalized lessons may be published without original text,
identifying details, code or measurements. Label their nonpublic provenance and
evidence limits; do not imply that public citations reproduce those experiments.
